    ...
    Slider.prototype = {
        ...
        setLayout: function(){
            ...
            if(this.options.isShowControls){
                this.$prev = $('<a href="javascript:;" class="hiSlider-btn-prev"><i class="s-prev tb-ifont"></i></a>');
                this.$next = $('<a href="javascript:;" class="hiSlider-btn-next"><i class="s-next tb-ifont"></i></a>');
        ...
        getSetCss: function(){
            ...
            return {
                item: size,
                container: css,
                wrap: {'position': 'relative', 'width': size.width, 'height': size.height}
            }
        },
        autoPlay: function(){
            var self = this;
